...
> **2026-09-13:** все скиллы, перечисленные в этом файле, перенесены в
> глобальный каталог `~/.claude/skills/<имя>/SKILL.md` — теперь они
> доступны из любого проекта, а не только из этого. В `.claude/skills/`
> этого проекта их больше нет; сам файл оставлен как история проверки
> происхождения (кто автор, под какую версию/локаль написан скилл,
> какие риски проверялись при копировании). Актуальный список с
> категориями — `~/.claude/skills/CATALOG.md`.
